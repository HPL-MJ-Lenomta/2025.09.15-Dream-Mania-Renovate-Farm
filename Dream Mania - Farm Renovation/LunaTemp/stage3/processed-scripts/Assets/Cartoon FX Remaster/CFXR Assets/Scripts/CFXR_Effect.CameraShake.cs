...
namespace CartoonFX
{
	public partial class CFXR_Effect : MonoBehaviour
	{
		...
		public class CameraShake
		{
			...
			static void OnPreRenderCamera_Static_URP([Bridge.Ref] ScriptableRenderContext context, Camera cam)
			{
				OnPreRenderCamera_Static(cam);
			}
			static void OnPostRenderCamera_Static_URP([Bridge.Ref] ScriptableRenderContext context, Camera cam)
			{
