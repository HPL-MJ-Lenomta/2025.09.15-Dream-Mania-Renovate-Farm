...
public class AnimatedTileSpawner : MonoBehaviour
{
    ...
    public void Spawn(TileData data, [Bridge.Ref] Vector3 position, float delay)
    {
    ...
    public void Spawn(TileData data, [Bridge.Ref] Vector3 position, float delay, int value)
    {
        AnimatedTile tileObject = tileQueue.Dequeue();
