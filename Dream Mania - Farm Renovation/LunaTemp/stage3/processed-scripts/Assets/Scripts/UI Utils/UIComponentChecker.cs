...
namespace UIUtils
{
    public static class UIComponentChecker
    {
        ...
        /// <param name="checkAll">If all objects beyond first hit will be checked.</param>
        /// <returns></returns>
        public static bool CheckForComponent<T>([Bridge.Ref] Vector2 atPosition, bool checkAll = true) where T : MonoBehaviour
        {
        ...
        /// <param name="checkAll">If all objects beyond first hit will be checked.</param>
        /// <returns></returns>
        public static bool CheckForComponent<T>([Bridge.Ref] Vector2 atPosition, out T component, bool checkAll = true) where T : MonoBehaviour
        {
            component = null;
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static int CheckForComponents<T>([Bridge.Ref] Vector2 atPosition) where T : MonoBehaviour
        {
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static int CheckForComponents<T>([Bridge.Ref] Vector2 atPosition, out List<T> components) where T : MonoBehaviour
        {
            var pointerData = new PointerEventData(EventSystem.current);
            pointerData.position = atPosition;
        ...
        /// <returns></returns>
        public static List<T> GetComponents<T>([Bridge.Ref] Vector2 atPosition) where T : MonoBehaviour
        {
            var pointerData = new PointerEventData(EventSystem.current);
            pointerData.position = atPosition;
        ...
        /// <param name="gameObject"></param>
        /// <returns></returns>
        public static bool CheckForGameObject([Bridge.Ref] Vector2 atPosition, GameObject gameObject)
        {
            var pointerData = new PointerEventData(EventSystem.current);
            pointerData.position = atPosition;
